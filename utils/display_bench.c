...
/*   Updated: 2025/12/17 13:43:46 by aluslu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    display_bench(t_bench_infos infos)
{
    ...
    + infos.pa_count + infos.pb_count + 
    infos.ra_count + infos.rb_count + infos.rr_count + infos.rra_count + 
    infos.rrb_count + infos.rrr_count;
    ...
    else if (infos.strategy == ADAPTIVE && (infos.disorder >= 0.20 && infos.disorder < 0.50))
    ...
    (int) (infos.disorder * 100), str_strategy, infos.total_ops, infos.sa_count, 
    infos.sb_count, infos.ss_count, infos.pa_count, infos.pb_count,
    infos.ra_count, infos.rb_count, infos.rr_count, infos.rra_count,
    infos.rrb_count, infos.rrr_count);
    return ;
}